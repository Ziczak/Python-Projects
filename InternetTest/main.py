...
Label(root, text="PING", font="arial 10 bold", bg="#384056").place(x=56, y=5)
Label(root, text="DOWNLOAD", font="arial 10 bold", bg="#384056").place(x=145, y=5)
Label(root, text="UPLOAD", font="arial 10 bold", bg="#384056").place(x=265, y=5)

Label(root, text="MS", font="arial 9 bold", bg="#384056", fg="white").place(x=58, y=80)
Label(root, text="MBPS", font="arial 9 bold", bg="#384056", fg="white").place(x=162, y=80)
Label(root, text="MBPS", font="arial 9 bold", bg="#384056", fg="white").place(x=272, y=80)
