...
heading = Label(root, text="Spell Checker", font=("Trebuchet MS", 30, "bold"), bg="#dae6f6", fg="#364971")
...
button = Button(root, text="Check", font=("arial", 20, "bold"), fg="#FFFFFF", bg="#FF0000", command=check_spelling)
button.pack()
