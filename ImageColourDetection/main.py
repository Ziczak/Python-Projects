...
root = Tk()
root.title("Colour Picker From Image")
...
Label(frame, text="Colour Finder", font="arial 25 bold", bg="white").place(x=100, y=20)

colours = Canvas(frame, bg="#fff", width=150, height=265, bd=0)
colours.place(x=20, y=90)

id1 = colours.create_rectangle((10, 10, 50, 50), fill="#b8255f")
id2 = colours.create_rectangle((10, 50, 50, 100), fill="#db4035")
id3 = colours.create_rectangle((10, 100, 50, 150), fill="#ff9933")
id4 = colours.create_rectangle((10, 150, 50, 200), fill="#fad000")
id5 = colours.create_rectangle((10, 200, 50, 250), fill="#afb83b")

hex1 = Label(colours, text="#b8255f", fg="#000", font="arial 12 bold", bg="white")
hex1.place(x=60, y=15)

hex2 = Label(colours, text="#db4035", fg="#000", font="arial 12 bold", bg="white")
hex2.place(x=60, y=65)

hex3 = Label(colours, text="#ff9933", fg="#000", font="arial 12 bold", bg="white")
hex3.place(x=60, y=115)

hex4 = Label(colours, text="#fad000", fg="#000", font="arial 12 bold", bg="white")
hex4.place(x=60, y=165)

hex5 = Label(colours, text="#afb83b", fg="#000", font="arial 12 bold", bg="white")
hex5.place(x=60, y=215)

colours2 = Canvas(frame, bg="#fff", width=150, height=265, bd=0)
colours2.place(x=180, y=90)

id6 = colours2.create_rectangle((10, 10, 50, 50), fill="#7ecc49")
id7 = colours2.create_rectangle((10, 50, 50, 100), fill="#299438")
id8 = colours2.create_rectangle((10, 100, 50, 150), fill="#6accbc")
id9 = colours2.create_rectangle((10, 150, 50, 200), fill="#158fad")
id10 = colours2.create_rectangle((10, 200, 50, 250), fill="#14aaf5")

hex6 = Label(colours2, text="#7ecc49", fg="#000", font="arial 12 bold", bg="white")
hex6.place(x=60, y=15)

hex7 = Label(colours2, text="#299438", fg="#000", font="arial 12 bold", bg="white")
hex7.place(x=60, y=65)

hex8 = Label(colours2, text="#6accbc", fg="#000", font="arial 12 bold", bg="white")
hex8.place(x=60, y=115)

hex9 = Label(colours2, text="#158fad", fg="#000", font="arial 12 bold", bg="white")
hex9.place(x=60, y=165)

hex10 = Label(colours2, text="#14aaf5", fg="#000", font="arial 12 bold", bg="white")
...
Button(selectimage, text="Find Colours", width=12, height=1, font="arial 14 bold", command=findcolour).place(x=228,
                                                                                                             y=300)
